  ...
  return (
    user && <main className='user_main'>
      ...
      <section className='user_profile_section'>
        ...
        {user.blog && <section className='user_blog_section'>
        ...
        {user.company && <section className='user_blog_section'>
        ...
        {user.location && <section className='user_blog_section'>
        ...
        {user.email && <section className='user_blog_section'>
